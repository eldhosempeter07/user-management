import { ADD_USER, ADD_USER_BEGIN, ADD_USER_FAIL, ADD_USER_SUCCESS, DELETE_USER, 
    DELETE_USER_BEGIN, DELETE_USER_FAIL, DELETE_USER_SUCCESS, GET_USER, GET_USER_BEGIN, GET_USER_BY_ID, GET_USER_BY_ID_BEGIN, 
    GET_USER_BY_ID_FAIL, GET_USER_BY_ID_SUCCESS, GET_USER_FAIL, GET_USER_SUCCESS, UPDATE_USER, UPDATE_USER_BEGIN, UPDATE_USER_FAIL,
...
export const updateUsers = (data:object,id:string,callback:()=>void) =>({
    type:UPDATE_USER,
    data:data,
    id:id,
    callback:callback
